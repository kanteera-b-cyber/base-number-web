...
4. ใส่ค่า `NEXT_PUBLIC_SUPABASE_URL`, `NEXT_PUBLIC_SUPABASE_ANON_KEY` และ `SUPABASE_SERVICE_ROLE_KEY` จาก **Project Settings > API**
5. เปิด [http://localhost:3000/api/health](http://localhost:3000/api/health) เพื่อตรวจการเชื่อมต่อฐานข้อมูล ต้องได้ `{ "ok": true }`
